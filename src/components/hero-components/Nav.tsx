...
const Nav: React.FC<NavProps> = () => {
  ...
  // Prevents popout nav from being visible before mount
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  // Don't render menu until component is mounted
  if (!mounted) {
    return (
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showMenu && mounted && (
          <motion.div
            className="fixed h-[100dvh] top-0 left-0 right-0 bg-black bg-opacity-55 z-50 backdrop-blur-[4px] flex p-6 justify-end"
