...
const About: React.FC<AboutProps> = () => {
  return (
    <div className="py-12  px-6 lg:px-16 relative" id="about">
  ...
  return (
    <div className="w-full py-6 mb-6">
      ...
      <div className="flex mt-10">
        ...
        <div className="w-1/3 pr-3 flex flex-col items-center lg:items-start">
          <p className="text-4xl nohemi">
    ...
    <AnimatedFadeUp>
      <div className="w-full py-6 rounded-xl flex flex-col md:flex-row gap-10 md:gap-0">
        <div className="md:w-1/2 pr-2">
          <p className="font-medium flex flex-wrap items-center text-base lg:text-lg">
            <img src="/icons/uf.png" alt="" className="max-w-8 mr-0.5" />
            University of Florida College of Engineering
            <span className="font-[350]">&nbsp;/ Computer Science</span>
          </p>
          <p className="mt-1 pl-1 text-sm lg:text-base">Bachelor of Science, 2023-Current </p>
          <p className="mt-3 ml-1 bg-gray-200 w-fit text-xs lg:text-sm  px-4 py-1 rounded-full">
            In Progress
          </p>
        </div>
        <div className="md:w-1/2 md:pl-2">
          ...
          <p className="mt-1 pl-1 text-sm lg:text-base">Academic Minor, 2023-Current </p>
          <p className="mt-3 ml-1 bg-gray-200 w-fit text-xs lg:text-sm  px-4 py-1 rounded-full">
            In Progress
          </p>
        </div>
  ...
  return (
    <AnimatedFadeUp>
      <div className="w-full border border-[#ebeaee] px-4 py-6 bs rounded-xl mb-6">
        <p className="font-medium text-base lg:text-lg">Frontend Developement</p>
        <p className="flex font-[350]  mt-2.5 mb-4 text-sm lg:text-base">
        ...
        <ul className="flex flex-wrap gap-4">
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/react.svg" alt="" className="max-w-4 lg:max-w-5" />
            React
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/nextjs.svg" alt="" className="max-w-4 lg:max-w-5" />
            NextJS
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/typescript.svg" alt="" className="max-w-4 lg:max-w-5" />
            Typescript
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/tailwind.png" alt="" className="max-w-4 lg:max-w-5" />
            Tailwind CSS
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/figma.svg" alt="" className="max-w-2.5 lg:max-w-3.5" />
            Figma
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/git.png" alt="" className="max-w-4 lg:max-w-5" />
            Version Control
          </p>
        </ul>
      </div>
    ...
    <AnimatedFadeUp>
      <div className="w-full border border-[#ebeaee] px-4 py-6 bs rounded-xl mb-8">
        ...
        <ul className="flex gap-4 flex-wrap">
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/fast.svg" alt="" className="max-w-4 lg:max-w-5" />
            Fast API
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/psql.png" alt="" className="max-w-4 lg:max-w-5" />
            PostgreSQL
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/mongo.svg" alt="" className="max-w-4 lg:max-w-5" />
            Mongo DB
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/firebase.svg" alt="" className="max-w-4 lg:max-w-5" />
            Firebase
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
            <img src="/icons/docker.png" alt="" className="max-w-4 lg:max-w-5" />
            Docker
          </p>
          <p className="flex items-center gap-1.5 text-sm font-[350] ">
